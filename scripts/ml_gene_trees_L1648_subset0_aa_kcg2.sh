...
#SBATCH --output=log/ml_gene_trees_L1648_subset0_aa_kcg2.%A_%a.out
#SBATCH --error=log/ml_gene_trees_L1648_subset0_aa_kcg2.%A_%a.err
...
# Run Iq-tree
iqtree -nt 2 \
 -pre analyses/L1648/trees/single/kcg2/aa/${locus}_kcg2 \
