...
#SBATCH --output=log/trimal_L1648_ng_%A_%a.out
#SBATCH --error=log/trimal_L1648_ng_%A_%a.err
...
-out analyses/L1648/alignments/single/${locus}_ng.faa \
-fasta -nogaps
# Trim NA alignments
trimal -in analyses/L1648/alignments/single/${locus}_aln.fna \
-out analyses/L1648/alignments/single/${locus}_ng.fna \
-fasta -nogaps