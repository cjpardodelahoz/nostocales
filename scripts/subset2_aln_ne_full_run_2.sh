...
AMAS.py remove -i analyses/ancestral_ne/full_run_2/seqs/*.fna -f fasta -d dna \
 -x $(cat misc_files/taxa_dropped_subset2.txt) \
 --out-prefix analyses/ancestral_ne/full_run_2/seqs/
# Modify filenames
for aln in $(ls analyses/ancestral_ne/full_run_2/seqs/*-out.fas) ; do
