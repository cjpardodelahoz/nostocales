...
#SBATCH --output=log/ml_gene_trees_L1648_subset0_aa_strict.%A_%a.out
#SBATCH --error=log/ml_gene_trees_L1648_subset0_aa_strict.%A_%a.err
...
# Run Iq-tree
iqtree -nt 2 \
 -pre analyses/L1648/trees/single/strict/aa/${locus}_strict \
